    ...
    <div id="container">
            ...
            <div class="content_l">
                    ...
                    <dd class="job_request">
                    	<span class="red">${position.positionSalaryRange}</span>
                       	<span>${position.positionLocation}</span> 
                       	<span>${position.positionExperience} </span>
                       	<span>  ${position.positionEducation}</span> 
                       	<span>全职</span><br />
                      	   ${position.positionBenefits1} ！${position.positionBenefits2}！${position.positionBenefits3}... 你还在等什么！！
                    </dd>
                    <dd class="job_bt">
                        <h3 class="description">职位描述</h3>
                             ${position.positionDescription}
                                        	...
                                        	<dd class="unresume">
	                        <div>
	                        	你在树懒还没有简历呢，你可以<a href="login.html" target="_blank" title="完善在线简历">完善在线简历</a>，也可<a class="inline" href="#loginPop" title="登录">上传附件简历</a>直接投递
	                       	</div>
	                    </dd>
            ...
            <div class="content_r">
                <dl class="job_company">
                    	<a href="http://dev.hqyj.com/" target="_blank">
                    ...
                    <dd>
                    	<ul class="c_feature reset">
                        	<li><span>领域</span>  ${position.companyType} </li>
                        	<li><span>规模</span> ${position.companyScale} </li>
                        	<li>
                        		<span>主页</span> 
                        		           							<a href=${position.companyUrl} target="_blank" title="http://L99.com" rel="nofollow">${position.companyUrl}</a>
           						                        	</li>
                        </ul>
                        ...
                        <div id="addLabel" class="addLabel dn">
                            ...
                            <input type="submit" id="add" value="贴上" />
                       	                       	...
                       	                       	<h4>工作地址</h4>
                       	<div> ${position.companyAddress} </div>
